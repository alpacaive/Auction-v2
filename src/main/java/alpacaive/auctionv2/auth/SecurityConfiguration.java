...
public class SecurityConfiguration {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        .authorizeHttpRequests((authz)-> authz
				...
				.requestMatchers("/","/all/**", "/join", "/error", "/login", "/adjoin" , "/idcheck","/app.js","/favicon.ico","/price.js","/images/**", "/css/**", "/images/**", "/js/**", "/style.css","/notice.js","/webjars/**", "/event/**", "/attendancecheck").permitAll()
